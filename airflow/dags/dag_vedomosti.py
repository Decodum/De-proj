...
from vedomosti import fetch_rss_vedomosti_initial, fetch_rss_vedomosti_incremental
...
with DAG(dag_id='give_me_news',
    ...
    fetch_data_initial_task = PythonOperator(
        task_id="fetch_vedomosti_initial",
        python_callable=fetch_rss_vedomosti_initial
    )

    fetch_data_incremental_task = PythonOperator(
        task_id="fetch_vedomosti_incremental",
        python_callable=fetch_rss_vedomosti_incremental
    )
